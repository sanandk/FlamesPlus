...
public class Mode3Activity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pickFriendsButton = (Button) findViewById(R.id.button3);
...
btn1.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
		// TODO Auto-generated method stub
		if(Globals.screens!=2)
		{
			btn1.setImageResource(R.drawable.btn1);
			btn2.setImageResource(R.drawable.btn2);
			btn3.setImageResource(R.drawable.btn3p);
			Toast msg = Toast.makeText(Mode3Activity.this,
                    "Already in Mode 3!!", Toast.LENGTH_LONG);
		    msg.show();
    ...
    private void onSessionStateChange(Session session, SessionState state, Exception exception) {
        if (pendingAction != PendingAction.NONE &&
            ...
            new AlertDialog.Builder(Mode3Activity.this)
    ...
    private void showPickerFragment(PickerFragment<?> fragment) {
        fragment.setOnErrorListener(new PickerFragment.OnErrorListener() {
            ...
            public void onError(PickerFragment<?> pickerFragment, FacebookException error) {
                ...
                Toast toast = Toast.makeText(Mode3Activity.this, text, Toast.LENGTH_SHORT);
                toast.show();
            }
        });
